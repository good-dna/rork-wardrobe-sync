...
// FIX: Exported so AuthProvider or _layout can check this before showing onboarding
export const ONBOARDING_SEEN_KEY = 'klotho_onboarding_seen';
...
// FIX: Standardized brand name to "Klotho" throughout
const screens: OnboardingScreenType[] = [
  ...
  },
  {
    id: 2,
    title: 'Dress Smart,\nAnywhere',
    subtitle: 'Klotho checks your local forecast to\nrecommend weather-perfect looks.',
    icon: (
...
export default function OnboardingScreen() {
  ...
  // FIX: Mark onboarding as seen before navigating away so it never reruns
      ...
      >
        <SafeAreaView style={styles.safeArea}>
          <View style={styles.content}>
            {/* Brand — FIX: Standardized to "Klotho" */}
            <View style={styles.brandContainer}>
              <Text style={styles.brandText}>Klotho</Text>
            </View>
